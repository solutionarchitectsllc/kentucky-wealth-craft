      ...
      <div className="container-x grid gap-10 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex gap-3"><Mail className="h-4 w-4 mt-0.5 text-brand-emerald-bright shrink-0" /><a href="mailto:notify@solutionarchitectsllc.com" className="hover:text-brand-emerald-bright">notify@solutionarchitectsllc.com</a></li>
          </ul>
        </div>
      </div>
